...
export default function OrphanageDetails() {
  ...
  const handlerOpenGoogleMapsRoutes = () => Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanage?.latitude},${orphanage?.longitude}`)
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity style={styles.routesContainer} onPress={handlerOpenGoogleMapsRoutes} >
